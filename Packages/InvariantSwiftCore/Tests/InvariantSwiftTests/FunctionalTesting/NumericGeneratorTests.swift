...
struct NumericGeneratorTests {
  ...
  func int8GeneratorBasicCoverage() async {
    let property = Property<Int8>(generator: Gen<Int8>.int8) { _ in true }
  ...
  func int16GeneratorComprehensiveCoverage() async {
    let property = Property<Int16>(generator: Gen<Int16>.int16) { value in
  ...
  func int16GeneratorEdgeCases() async {
    ...
    for _ in 0..<1000 {
      let value = Gen<Int16>.int16.generate(&rng, Size(value: 50))
  ...
  func int32GeneratorComprehensiveCoverage() async {
    let property = Property<Int32>(generator: Gen<Int32>.int32) { value in
  ...
  func int64GeneratorComprehensiveCoverage() async {
    let property = Property<Int64>(generator: Gen<Int64>.int64) { value in
  ...
  func intShrinkingBehaviorValidation() async {
    let property = Property<Int>(generator: Gen<Int>.int) { value in
      ...
      // magnitude, not abs: Gen<Int>.int emits Int.min, where abs traps.
      value.magnitude < 5
    }
  ...
  func int8OverflowUnderflowBoundaryTesting() async {
    let property = Property<Int8>(generator: Gen<Int8>.int8) { value in
  ...
  func comprehensiveNumericTypeIntegrationTest() async {
    ...
    let nestedGenerator = Gen<Int>.int.zip(Gen.float).zip(Gen.double).zip(Gen.uint32)
