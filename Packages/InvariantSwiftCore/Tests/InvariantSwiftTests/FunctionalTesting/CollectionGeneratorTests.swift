...
struct CollectionGeneratorTests {
  ...
  func arrayGeneratorBasicCoverage() async {
    let property = Property<[Int]>(generator: Gen<[Int]>.array(Gen<Int>.int)) { _ in true }
  ...
  func arrayGeneratorShrinking() async {
    let property = Property<[Int]>(generator: Gen<[Int]>.array(Gen<Int>.int(in: 1...100))) {
      array in  // swiftlint:disable:this closure_parameter_position
  ...
  func arrayGeneratorStringElements() async {
    let property = Property<[String]>(generator: Gen<[String]>.array(Gen<String>.string)) { _ in
      true
    }
    let result = await PropertyRunner().runProperty(
      property,
  ...
  func setGeneratorBasicCoverage() async {
    let setGen = Gen<Set<Int>>.set(Gen<Int>.int)
  ...
  func setGeneratorUniqueness() async {
    let setGen = Gen<Set<Int>>.set(Gen<Int>.int(in: 1...10))
  ...
  func setGeneratorShrinking() async {
    let setGen = Gen<Set<Int>>.set(Gen<Int>.int(in: 1...50))
    let property = Property<Set<Int>>(generator: setGen) { set in
  ...
  func setGeneratorStringElements() async {
    let setGen = Gen<Set<String>>.set(Gen<String>.string)
  ...
  func dictionaryGeneratorKeyUniqueness() async {
    let dictGen = Gen<[Int: String]>.dictionary(Gen<Int>.int(in: 1...10), Gen<String>.string)
  ...
  func dictionaryGeneratorShrinking() async {
    let dictGen = Gen<[String: Int]>.dictionary(Gen<String>.string, Gen<Int>.int(in: 1...100))
  ...
  func dictionaryGeneratorComplexTypes() async {
    let dictGen = Gen<[Int: [String]]>.dictionary(
      Gen<Int>.int,
      Gen<[String]>.array(Gen<String>.string)
    )
    let property = Property<[Int: [String]]>(
      generator: dictGen
    ) { _ in true }
  ...
  func rangeGeneratorBasicCoverage() async {
    let property = Property<Range<Int>>(generator: Gen<Range<Int>>.intRange) { _ in true }
    let result = await PropertyRunner().runProperty(
      property,
      config: PropertyConfig(iterations: 50)
    )
  ...
  func rangeGeneratorValidity() async {
    let property = Property<Range<Int>>(generator: Gen<Range<Int>>.intRange) { range in
  ...
  func rangeGeneratorEdgeCases() async {
    let property = Property<Range<Int>>(generator: Gen<Range<Int>>.intRange) { range in
      ...
      (range.upperBound - range.lowerBound) <= 1000
    }
    let result = await PropertyRunner().runProperty(
      property,
      config: PropertyConfig(iterations: 100)
  ...
  func closedRangeGeneratorBasicCoverage() async {
    let property = Property<ClosedRange<Int>>(generator: Gen<ClosedRange<Int>>.intClosedRange) {
      _ in true  // swiftlint:disable:this closure_parameter_position
    }
    let result = await PropertyRunner().runProperty(
      property,
      config: PropertyConfig(iterations: 50)
  ...
  func closedRangeGeneratorValidity() async {
    let property = Property<ClosedRange<Int>>(generator: Gen<ClosedRange<Int>>.intClosedRange) {
      range in  // swiftlint:disable:this closure_parameter_position
  ...
  func partialRangeFromGeneratorBasicCoverage() async {
    let property = Property<PartialRangeFrom<Int>>(
      generator: Gen<PartialRangeFrom<Int>>.intPartialRangeFrom
    ) { _ in true }
    let result = await PropertyRunner().runProperty(
      property,
      config: PropertyConfig(iterations: 50)
  ...
  func partialRangeUpToGeneratorBasicCoverage() async {
    let property = Property<PartialRangeUpTo<Int>>(
      generator: Gen<PartialRangeUpTo<Int>>.intPartialRangeUpTo
    ) { _ in true }
    let result = await PropertyRunner().runProperty(
      property,
      config: PropertyConfig(iterations: 50)
  ...
  func partialRangeThroughGeneratorBasicCoverage() async {
    let property = Property<PartialRangeThrough<Int>>(
      generator: Gen<PartialRangeThrough<Int>>.intPartialRangeThrough
    ) { _ in
      true
    }
    let result = await PropertyRunner().runProperty(
  ...
  func arraySliceGeneratorBasicCoverage() async {
    let arraySliceGen = Gen<ArraySlice<Int>>.arraySlice(Gen<Int>.int)
  ...
  func arraySliceGeneratorProperties() async {
    let arraySliceGen = Gen<ArraySlice<String>>.arraySlice(Gen<String>.string)
  ...
  func arraySliceGeneratorShrinking() async {
    let arraySliceGen = Gen<ArraySlice<Int>>.arraySlice(Gen<Int>.int(in: 1...100))
  ...
  func mixedCollectionTypes() async {
    let innerSetGen = Gen<Set<Int>>.set(Gen<Int>.int)
    let dictGen = Gen<[String: Set<Int>]>.dictionary(Gen<String>.string, innerSetGen)
