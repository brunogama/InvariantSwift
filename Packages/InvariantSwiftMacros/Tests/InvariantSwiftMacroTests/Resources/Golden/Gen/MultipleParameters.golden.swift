...
private enum testWithMultipleGen_PropertyTest {
    @Test("testWithMultipleGen", InvariantSwiftPropertyExecutionTrait(testName: "testWithMultipleGen", labels: ["small", "mediumString"], configuredSeed: nil), .tags(.invariantSwiftPropertyBased)) static func run() throws {
        ...
        try executeGeneratedPropertyTest(property, config: config, testName: "testWithMultipleGen", labels: ["small", "mediumString"], persistFailures: false)
    }
}
