...
public actor ClassificationCoverageSystem {
  ...
  public struct CoverageContract: Codable, Sendable {
    ...
    public enum ValidationMode: String, Codable, CaseIterable, Sendable {
      case strict  // All requirements must be met
      case bestEffort = "best_effort"  // Try to meet requirements, warn on failures
      case advisory  // Report coverage but don't fail tests
    }
  ...
  public struct ComplianceViolation: Codable, Sendable {
    ...
    public enum ViolationType: String, Codable, CaseIterable, Sendable {
      ...
      case missingClassification = "missing_classification"
  ...
  public struct CoverageRecommendation: Codable, Sendable {
    ...
    public enum RecommendationType: String, Codable, CaseIterable, Sendable {
      case increaseSamples = "increase_samples"
      case addClassification = "add_classification"
      case rebalanceDistribution = "rebalance_distribution"
      case extendTestingTime = "extend_testing_time"
      case refineClassifier = "refine_classifier"
    }
