...
`@Idempotent`, `@Deterministic`, and `@Pure` all generate property-based tests, but they answer different questions. Import `InvariantSwiftMacroAPI` alongside `InvariantSwiftTesting` when you use them.
