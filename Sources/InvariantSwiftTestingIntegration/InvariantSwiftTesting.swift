// InvariantSwiftTesting (via InvariantSwiftTestingIntegration directory)
// Swift Testing framework integration for property-based tests.
...
// - Failure reporting and persistence
// - ExpectDifference helpers
