...
- Pre-commit hooks enforce branch protection (`main`/`dev` direct commits are rejected) and prevent committing `.swift.disabled` files. Release automation generates the changelog.
