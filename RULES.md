...
4. **Tests pass** (Swift packages: `set -o pipefail; swift test | xcbeautify --preserve-unbeautified -q`). Preserve the test command's exit status when formatting its output.
