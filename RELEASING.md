...
The release workflow generates `CHANGELOG.md` with git-cliff from Conventional Commits.
...
6. Verify that the release workflow generates the intended `CHANGELOG.md` entries.
