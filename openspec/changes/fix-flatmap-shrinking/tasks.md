...
## 2. Implement
- [x] 2.1 Remove or rewrite `Shrink.flatMap` and `Shrink.contramap` to be valid under ShrinkTree
- [x] 2.2 Implement `Gen.flatMap` shrinking using ShrinkTree composition
- [x] 2.3 Add property tests: flatMap generator shrinks to a smaller failing input
